<template lang="html">
  <v-container grid-list-md text-xs-center>
    <v-layout row wrap>
      <h4>{{vendor.vendor_title}}</h4>

    <!--  <onboard-booking></onboard-booking> -->
    ...
    <div class="input-group spacer">
      ...
      <select class="custom-select" id="inputGroupSelect02" v-model="booking.service_render_id">
        <option selected>Choose...</option>
          <option :value="service.id" v-for="service in vendor.servicerenders">
              {{service.price}}
          </option>
        </select>
    </div>
